// exp13-ivf-f32-c1024-np16: IVF-F32 with C=1024 centroids, nprobe=8.
//
// Tighter clusters than exp09 (C=512) → fewer ANN misses at same nprobe=8.
// Expected: 0 FP + 0 FN → detection_score=3000 → total ≈ +4026.
package main
