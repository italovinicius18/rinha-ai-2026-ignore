// exp15-haproxy-reuse: identical to exp09 (IVF-F32 C=512 nprobe=8) but with
// http-reuse aggressive in HAProxy. Tests whether per-request TCP connection
// overhead in HAProxy is the source of the ~170ms p99.
package main
