// exp08-ivf-f32-fast: IVF with float32 cluster vectors, C=512, optimized inner loop.
//
// Same format as exp07 (FormatIVF_F32) but searchAndCountF32 uses unsafe.Pointer
// cast + loop unrolling instead of byte-by-byte bit manipulation.
// Expected: ~0 FP + 1 FN, p99 ~200-250 ms (vs exp07's 887 ms).
package main
