// exp07-ivf-f32: IVF with float32 cluster vectors, C=512.
//
// Uses FormatIVF_F32: same IVF structure as exp05 but cluster vectors are
// stored as float32 instead of int8. Eliminates quantization error → expected
// ~0 FP + 1 FN (same as brutef32 brute force). Index ~168 MB (MAP_SHARED = free RSS).
package main
