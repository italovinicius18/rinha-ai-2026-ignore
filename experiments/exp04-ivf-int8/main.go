// exp04-ivf-int8: approximate k=5 KNN using an IVF index.
//
// At query time only nprobe (default 8) of 256 clusters are searched,
// giving ~32× fewer distance computations than brute force.
// Expected latency: ~0.5–1 ms/query vs ~15 ms for brute force.
package main
